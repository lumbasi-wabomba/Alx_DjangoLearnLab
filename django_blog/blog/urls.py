...
urlpatterns = [
    ...
    path('posts/', ListView.as_view({'get': 'list_posts'}), name='post_list'),
    path('posts/<int:pk>/', DetailView.as_view({'get': 'post_detail'}), name='post_detail'),
    path('posts/new/', CreateView.as_view(), name='post_create'),
    path('posts/<int:pk>/edit/', UpdateView.as_view(), name='post_edit'),
    path('posts/<int:pk>/delete/', DeleteView.as_view(), name='post_delete'),
]
